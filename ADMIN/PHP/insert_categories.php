...
<form method="post" action="">
    ...
    <div class="input-group mb-2">
        ...
        <input type="text" class="form-control border border-secondary" name="category_title" placeholder="Insert Category..." aria-label="Categories" aria-describedby="basic-addon1">
    </div>
    <!-- ******************************************** || Input Field Ends Here || *********************************************** -->

    <!-- ******************************************** || Insert Button Starts Here || *********************************************** -->
    <div class="input-group mb-2">
        <input type="submit" class="bg-secondary text-white border-0 p-2 my-2" name="insert_category" value="Insert Category" aria-describedby="basic-addon1">
    </div>
